...
async function POST(req) {
    try {
        ...
        const ok = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, user.passwordHash);
        if (!ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signJwt"])({
            id: user.id,
            login: user.login,
            role: user.role
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ffb4848._.js.map