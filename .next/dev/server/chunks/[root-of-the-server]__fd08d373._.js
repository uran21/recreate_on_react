...
async function GET(req) {
    ...
    const me = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyJwt"])(token);
    ...
    const days = Math.max(1, Math.min(365, Number(url.searchParams.get("days")) || 30)); // 1..365
    const perCategory = Math.max(1, Math.min(50, Number(url.searchParams.get("limit")) || 5)); // топ-N в категории
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd08d373._.js.map