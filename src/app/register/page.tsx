...
export default function RegisterPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    revalidate(["login", "password", "confirm", "city", "street", "houseNumber"]);
      ...
      <form onSubmit={onSubmit} noValidate>
        <div className="grid reg-grid">
          ...
          <div className="field col-login">
            ...
            <input
              id="login"
              className={`input ${touched.login && errs.login ? "is-invalid" : ""}`}
              value={login}
          ...
          <div className="field col-password">
            ...
            <input
              id="password"
              type="password"
              className={`input ${touched.password && errs.password ? "is-invalid" : ""}`}
              value={password}
              ...
              placeholder="Placeholder"
            />
            <div className="err">{touched.password ? errs.password || "" : ""}</div>
          </div>
          ...
          <div className="field col-confirm">
            ...
            <input
              id="confirm"
              type="password"
              className={`input ${touched.confirm && errs.confirm ? "is-invalid" : ""}`}
              value={confirm}
              ...
              placeholder="Placeholder"
            />
            <div className="err">{touched.confirm ? errs.confirm || "" : ""}</div>
          </div>
          ...
          <div className="field col-city">
            ...
            <select
              id="city"
              className={`input ${touched.city && errs.city ? "is-invalid" : ""}`}
              value={cityId}
          ...
          <div className="field col-street">
            ...
            <select
              id="street"
              className={`input ${touched.street && errs.street ? "is-invalid" : ""}`}
              value={streetId}
          ...
          <div className="field col-house">
            ...
            <input
              ...
              min={1}
              step={1}
              className={`input ${touched.houseNumber && errs.houseNumber ? "is-invalid" : ""}`}
              value={houseNumber}
              onChange={(e) => onHouseChange(e.target.value)}
              onBlur={() => markTouched("houseNumber")}
              placeholder="Placeholder"
            />
            <div className="err">{touched.houseNumber ? errs.houseNumber || "" : ""}</div>
          </div>
